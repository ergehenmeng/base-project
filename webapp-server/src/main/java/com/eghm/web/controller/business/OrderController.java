...
import static com.eghm.constants.LockConstant.REFUND_LOCK;
...
public class OrderController {
    ...
    @ApiOperation("零售创建订单")
    public RespBody<OrderCreateVO> itemGroupCreate(@RequestBody @Validated ItemOrderCreateDTO dto) {
    ...
    public RespBody<Void> ticketRefundApply(@RequestBody @Validated TicketRefundApplyDTO dto) {
        ...
        redisLock.lockVoid(REFUND_LOCK + context.getOrderNo(), 10_000, () -> this.refundApply(context, ProductType.TICKET, TicketEvent.REFUND_APPLY));
    ...
    public RespBody<Void> lineRefundApply(@RequestBody @Validated LineRefundApplyDTO dto) {
        ...
        redisLock.lockVoid(REFUND_LOCK + context.getOrderNo(), 10_000, () -> this.refundApply(context, ProductType.LINE, LineEvent.REFUND_APPLY));
        return RespBody.success();
    }
    ...
    public RespBody<Void> homestayRefundApply(@RequestBody @Validated HomestayRefundApplyDTO dto) {
        ...
        context.setApplyType(1);
        context.setNum(dto.getVisitorIds().size());
        redisLock.lockVoid(REFUND_LOCK + context.getOrderNo(), 10_000, () -> this.refundApply(context, ProductType.HOMESTAY, HomestayEvent.REFUND_APPLY));
        return RespBody.success();
    }
    ...
    public RespBody<Void> voucherRefundApply(@RequestBody @Validated VoucherRefundApplyDTO dto) {
        ...
        context.setMemberId(ApiHolder.getMemberId());
        context.setApplyType(1);
        redisLock.lockVoid(REFUND_LOCK + context.getOrderNo(), 10_000, () -> this.refundApply(context, ProductType.VOUCHER, VoucherEvent.REFUND_APPLY));
        return RespBody.success();
    }
    ...
    public RespBody<Void> itemRefundApply(@RequestBody @Validated ItemRefundApplyDTO dto) {
        ...
        redisLock.lockVoid(REFUND_LOCK + context.getOrderNo(), 10_000, () -> this.refundApply(context, ProductType.ITEM, ItemEvent.REFUND_APPLY));
        return RespBody.success();
    }
    ...
    public RespBody<Void> venueRefundApply(@RequestBody @Validated VenueRefundApplyDTO dto) {
        ...
        context.setNum(1);
        context.setMemberId(ApiHolder.getMemberId());
        redisLock.lockVoid(REFUND_LOCK + context.getOrderNo(), 10_000, () -> this.refundApply(context, ProductType.VENUE, VenueEvent.REFUND_APPLY));
        return RespBody.success();
    }
