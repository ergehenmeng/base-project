package com.eghm.interfaces.core.configuration.ratelimit;
...
public class RateLimitInterceptor implements InterceptorAdapter {
    ...
    public boolean beforeHandle(@Nonnull HttpServletRequest request, @Nonnull HttpServletResponse response,
        ...
        com.eghm.application.shared.annotation.RateLimiter rateLimit = this.getAnnotation(handler, com.eghm.application.shared.annotation.RateLimiter.class);
        if (rateLimit == null) {
            return true;
        }
     ...
     * 根据 scope 解析限流维度值
     */
    private String resolveScope(HttpServletRequest request, com.eghm.application.shared.annotation.RateLimiter.Scope scope) {
        if (scope == com.eghm.application.shared.annotation.RateLimiter.Scope.GLOBAL) {
            return "global";
        }
        if (scope == com.eghm.application.shared.annotation.RateLimiter.Scope.USER) {
