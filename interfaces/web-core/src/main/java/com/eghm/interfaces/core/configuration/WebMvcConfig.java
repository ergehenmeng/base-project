package com.eghm.interfaces.core.configuration;

import com.alibaba.ttl.threadpool.TtlExecutors;
import com.eghm.interfaces.core.configuration.jackson.DesensitizationAnnotationInterceptor;
import com.eghm.interfaces.core.configuration.jackson.DomainEnumJsonDeserializer;
import com.eghm.interfaces.core.configuration.jackson.DomainEnumJsonSerializer;
import com.eghm.interfaces.core.configuration.log.LogTraceFilter;
...
public class WebMvcConfig implements WebMvcConfigurer, AsyncConfigurer, ValidationConfigurationCustomizer {
    ...
    public void jsonNullToString() {
        ...
        simpleModule.setSerializers(new DomainEnumSerializers());
        simpleModule.setDeserializers(new DomainEnumDeserializers());
    ...
    public static class DomainEnumSerializers extends SimpleSerializers {

        @Override
        public JsonSerializer<?> findSerializer(SerializationConfig config, JavaType type, BeanDescription beanDesc) {
            if (type.isEnumType()) {
                return new DomainEnumJsonSerializer();
            }
            return super.findSerializer(config, type, beanDesc);
        }
    }

    public static class DomainEnumDeserializers extends SimpleDeserializers {

        @Override
        @SuppressWarnings({"rawtypes", "unchecked"})
        public JsonDeserializer<?> findEnumDeserializer(Class<?> type, DeserializationConfig config, BeanDescription beanDesc) {
            return new DomainEnumJsonDeserializer((Class<? extends Enum>) type);
        }
    }
}
