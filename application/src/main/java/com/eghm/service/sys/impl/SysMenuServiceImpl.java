...
import com.eghm.service.sys.SysMenuQueryGateway;
import com.eghm.service.sys.SysMenuService;
import com.eghm.sys.model.SysMenu;
import com.eghm.sys.repository.SysMenuRepository;
...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    private final SysMenuQueryGateway sysMenuQueryGateway;
    ...
    public void updateState(String id, Boolean state) {
        sysMenuRepository.updateState(id, state);
    }
