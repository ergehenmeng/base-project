...
import com.eghm.service.business.MemberQueryGateway;
...
public class MemberServiceImpl implements MemberService {
    ...
    public void updateState(Long memberId, MemberState state) {
        ...
        memberRepository.updateState(memberId, state);
    ...
    private Member getByMpOpenId(String openId) {
        return memberRepository.findByMpOpenId(openId);
    }
    ...
    private Member getByMaOpenId(String openId) {
        return memberRepository.findByMaOpenId(openId);
    }
