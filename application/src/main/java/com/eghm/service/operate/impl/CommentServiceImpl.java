...
import com.eghm.operate.repository.CommentRepository;
...
public class CommentServiceImpl implements CommentService {
    ...
    public void add(CommentDTO dto) {
        ...
        if (dto.getPid() != null) {
            commentRepository.updateReplyNum(dto.getPid(), 1);
        }
    }
    ...
    public void delete(Long id, Long memberId) {
        ...
        if (delete == 1 && comment.getPid() != null) {
            commentRepository.updateReplyNum(comment.getPid(), -1);
        }
    }
    ...
    public void praise(Long id) {
        ...
        commonService.praise(key, memberId.toString(), praise -> commentRepository.updatePraiseNum(id, Boolean.TRUE.equals(praise) ? 1 : -1));
    }
    ...
    public void updateTopState(Long id, Integer state) {
        commentRepository.updateTopState(id, state);
    }
