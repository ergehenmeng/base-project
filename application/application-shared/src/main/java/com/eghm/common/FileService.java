...
public interface FileService {
     ...
     * @return 文件保存的相对路径
     */
    FilePath saveFile(String key, UploadFile file);
     ...
     * @return 文件保存的相对路径
     */
    FilePath saveFile(String key, UploadFile file, String folder);
     ...
     * @return 文件保存的相对路径
     */
    FilePath saveFile(String key, UploadFile file, String folder, long maxSize);
     ...
     * @param maxSize 最大限制
     */
    default void checkSize(UploadFile file, long maxSize) {
