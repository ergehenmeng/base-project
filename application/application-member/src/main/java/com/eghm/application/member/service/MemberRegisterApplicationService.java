...
@Service
@AllArgsConstructor
public class MemberRegisterApplicationService {
    ...
    private Member doRegister(MemberRegister register) {
        ...
        member.initializeRegistration(memberId, StringUtil.encryptNumber(memberId), member.getNickName(), today, today.format(
                DateUtil.MIN_FORMAT));
