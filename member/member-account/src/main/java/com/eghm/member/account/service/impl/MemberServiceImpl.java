...
import com.eghm.member.account.dto.AccountLoginDTO;
...
import com.eghm.member.account.vo.MemberRegisterVO;
import com.eghm.member.account.vo.MemberResponse;
import com.eghm.member.account.vo.MemberStatisticsVO;
import com.eghm.member.account.vo.MemberVO;
import com.eghm.member.account.vo.PieDataVO;
...
public class MemberServiceImpl implements MemberService {
    ...
    public MemberStatisticsVO sexChannel(DateRequest request) {
        ...
        List<PieDataVO> channelList = new ArrayList<>();
        ...
        List<PieDataVO> sexList = new ArrayList<>(8);
    ...
    private List<Boolean> getMonthSign(String signKey, LocalDate registerDate) {
        ...
        List<Boolean> monthList = new ArrayList<>(48);
        int bitmap = 1;
