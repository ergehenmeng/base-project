...
CREATE TABLE `banner`  (
  ...
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标题信息',
  `classify` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '轮播图类型:由system_dict的banner_classify维护(不同模块的轮播均在该表中维护)',
  `client_type` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '客户端类型 0:PC 1:APP',
  `img_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '轮播图片地址',
  `turn_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '轮播图点击后跳转的URL',
  `sort` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '轮播图顺序(大<->小) 最大的在最前面',
  `start_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '开始展示时间(可在指定时间后开始展示)',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '取消展示的时间(只在某个时间段展示)',
  `click` bit(1) NULL DEFAULT b'1' COMMENT '是否可点击 0:否 1:可以',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:未删除 1:已删除',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `type_client_type_index`(`classify`, `client_type`) USING BTREE COMMENT '组合索引',
  INDEX `type_index`(`classify`) USING BTREE,
  INDEX `client_type_index`(`classify`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '轮播图维护表' ROW_FORMAT = Compact;
...
CREATE TABLE `black_roster`  (
  ...
  `ip` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '访问ip',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '是否删除 0:未删除 1:已删除',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '黑名单截止时间',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '访问黑名单' ROW_FORMAT = Compact;
...
CREATE TABLE `feedback_log`  (
  ...
  `classify` tinyint(1) NULL DEFAULT NULL COMMENT '反馈类型分类',
  `state` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '状态: 0:待解决 1:已解决',
  `version` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '软件版本',
  `system_version` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统版本',
  `content` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '反馈内容',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '反馈时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `device_brand` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备厂商',
  `device_model` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备型号',
  `operator_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '处理人id',
  `operator_name` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '处理人姓名',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `index_status`(`state`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'APP用户反馈信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `help_center`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `classify` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '帮助分类取system_dict表中help_classify字段',
  `state` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '状态 0:不显示 1:显示',
  `ask` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '问',
  `answer` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '答 支持',
  `sort` tinyint(4) NULL DEFAULT 0 COMMENT '排序(小<->大)',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:不删除(正常) 1:已删除',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '帮助说明信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `image_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片名称',
  `classify` tinyint(3) UNSIGNED NULL DEFAULT NULL COMMENT '图片分类 数据字典image_classify',
  `url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件存放地址',
  `size` bigint(15) UNSIGNED NULL DEFAULT NULL COMMENT '文件大小',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:未删除 1:已删除',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '图片上传记录' ROW_FORMAT = Compact;
...
CREATE TABLE `login_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '用户id',
  `channel` tinyint(1) UNSIGNED NULL DEFAULT NULL COMMENT '登陆渠道',
  `ip` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登陆ip',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '登陆时间',
  `device_brand` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备厂商',
  `device_model` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '设备型号',
  `software_version` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '软件版本',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户登陆日志信息' ROW_FORMAT = Compact;
...
CREATE TABLE `push_template`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '消息名称',
  `nid` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '消息nid',
  `state` bit(1) NULL DEFAULT b'1' COMMENT '状态 0:关闭 1:开启',
  `classify` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '消息类型',
  `content` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '消息内容',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `tag` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '后置处理标示符(消息推送跳转页面)',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '推送消息模板表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sms_type` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '短信分类',
  `mobile` char(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `content` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '短信内容',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '发送时间',
  `state` tinyint(1) UNSIGNED NULL DEFAULT NULL COMMENT '发送状态 0:发送中 1:已发送 2:发送失败',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `mobile_index`(`mobile`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '短信日志记录表' ROW_FORMAT = Compact;
...
CREATE TABLE `sms_template`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `nid` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '短信模板nid即短信类型',
  `content` char(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '短信内容',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '短信模板类型' ROW_FORMAT = Compact;
...
CREATE TABLE `system_address`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '区域名称',
  `nid` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '区域代码',
  `pid` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '父级区域代码',
  `zip_code` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮编',
  `mark` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标示符-首字母',
  `classify` tinyint(1) UNSIGNED NULL DEFAULT NULL COMMENT '分类 省份1级 市2级 县3级',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3574 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '省市县代码表' ROW_FORMAT = Compact;
...
CREATE TABLE `system_cache`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '缓存名称',
  `cache_name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '缓存名称 必须与CacheConstant中保持一致',
  `state` tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '缓存更新状态 0:未更新 1:更新成功 2:更新失败',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注说明',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '缓存信息管理表' ROW_FORMAT = Compact;
...
CREATE TABLE `system_config`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `nid` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '参数标示符',
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '参数名称',
  `content` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '参数值',
  `classify` tinyint(2) UNSIGNED NULL DEFAULT 1 COMMENT '参数类型,见system_dict表nid=config_classify',
  `locked` bit(1) NULL DEFAULT b'0' COMMENT '锁定状态(禁止编辑) 0:未锁定,1:锁定',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `nid_index`(`nid`) USING BTREE,
  INDEX `type_index`(`classify`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统参数配置信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of system_config
-- ----------------------------
INSERT INTO `system_config` VALUES (1, 'application_name', '后台系统名称', '后台管理系统', 1, b'0', '', '2018-01-12 10:01:04', '2019-01-22 17:37:12');
INSERT INTO `system_config` VALUES (2, 'enterprise_name', '企业名称', '二哥很猛', 1, b'0', NULL, '2018-02-08 14:38:59', NULL);
INSERT INTO `system_config` VALUES (3, 'enterprise_address', '企业地址', '浙江省杭州市余杭区中泰街道338号', 1, b'0', NULL, '2018-02-08 14:40:01', NULL);
INSERT INTO `system_config` VALUES (4, 'enterprise_phone', '企业电话', '0571-00000000', 1, b'0', NULL, '2018-02-08 14:40:46', NULL);
INSERT INTO `system_config` VALUES (5, 'enterprise_email', '企业邮箱', '664956140@qq.com', 1, b'0', NULL, '2018-02-08 14:41:22', NULL);
INSERT INTO `system_config` VALUES (6, 'ios_latest_version', 'ios最新版本号', '1.2.3', 1, b'0', '最新版本号,格式必须为x.x.x', '2018-09-28 10:50:03', NULL);
INSERT INTO `system_config` VALUES (7, 'android_latest_version', 'android最新版本', '1.2.3', 1, b'0', '最新版本号,格式必须为x.x.x', '2018-09-28 10:50:41', NULL);
INSERT INTO `system_config` VALUES (11, 'system_domain', '前台系统域名', 'http://www.eghm.top', 1, b'0', '前台提供服务的域名', '2018-11-25 21:02:17', NULL);
INSERT INTO `system_config` VALUES (12, 'system_ip', '前台系统IP', 'http://127.0.0.1:8080', 1, b'0', '前台提供服务的ip', '2018-11-25 21:03:13', NULL);
INSERT INTO `system_config` VALUES (13, 'manage_domain', '后台系统域名', 'http://www.baidu.com', 1, b'0', NULL, '2018-11-29 16:41:04', NULL);
INSERT INTO `system_config` VALUES (14, 'operation_log_switch', '操作日志开关', '0', 1, b'0', '操作日志开关 0:不开启操作日志 1:开启操作日志', '2019-01-17 16:50:54', NULL);
INSERT INTO `system_config` VALUES (15, 'env', '系统环境', '2', 2, b'0', '1 生产 2 开发 3  测试', '2019-01-22 17:23:19', NULL);
INSERT INTO `system_config` VALUES (16, 'timestamp_deviation', '客户端与服务端时间容错值', '30000', 1, b'0', '单位:毫秒', '2019-07-10 16:50:31', '2019-07-10 16:52:43');
INSERT INTO `system_config` VALUES (17, 'send_from', '系统邮件发件人', '664956140@qq.com', 2, b'0', NULL, '2019-07-10 16:53:01', '2019-07-10 16:53:14');
INSERT INTO `system_config` VALUES (19, 'sso_open', '是否开启单设备单点登录', '1', 2, b'0', '0:不开启 1:开启', '2019-08-13 15:45:39', '2019-08-13 15:45:39');
INSERT INTO `system_config` VALUES (20, 'nick_name_prefix', '默认昵称前缀', 'eghm_', 1, b'0', '昵称为空时会自动生成以此为前缀的昵称', '2019-08-19 16:06:04', '2019-08-19 16:06:04');
INSERT INTO `system_config` VALUES (21, 'sms_type_interval', '同一类型短信发送间隔', '60', 1, b'0', '单位秒', '2019-08-20 17:18:53', '2019-08-20 17:18:53');
INSERT INTO `system_config` VALUES (22, 'sms_type_hour', '同一类型短信单小时总次数', '10', 1, b'0', '一小时同一类型最多发送次数', '2019-08-20 17:21:51', '2019-08-20 17:21:51');
INSERT INTO `system_config` VALUES (23, 'sms_type_day', '同一类型短信一天总次数', '20', 1, b'0', '一天内同一类型最多发送次数', '2019-08-20 17:23:50', '2019-08-20 17:23:50');
INSERT INTO `system_config` VALUES (24, 'sms_day', '同一天同手机号最大次数', '50', 1, b'0', '一个手机号一天内最多发送次数', '2019-08-20 17:26:02', '2019-08-20 17:26:02');
INSERT INTO `system_config` VALUES (25, 'notice_limit', '公告显示多少条', '5', 1, b'0', '首页公告轮播条数', '2019-08-22 11:53:19', '2019-08-22 11:53:19');
INSERT INTO `system_config` VALUES (26, 'app_store_url', '苹果AppStore访问地址', 'https://apps.apple.com/cn/app/%E4%B8%AA%E4%BA%BA%E6%89%80%E5%BE%97%E7%A8%8E/id1436002627', 1, b'0', NULL, '2019-08-22 15:47:19', '2019-11-15 16:44:50');
INSERT INTO `system_config` VALUES (27, 'file_server_address', '文件服务器地址', 'http://127.0.0.1:8080', 1, b'0', NULL, '2019-08-28 17:25:14', '2019-11-15 16:44:51');
INSERT INTO `system_config` VALUES (28, 'wechat_applet_id', '微信小程序appId', 'wxd90x7ec99b9d4f04', 1, b'0', NULL, '2019-09-10 13:35:46', '2019-11-15 16:44:54');
INSERT INTO `system_config` VALUES (29, 'wechat_applet_secret', '微信小程序secret', '221a466f3956831a66f90010541e59ae', 1, b'0', NULL, '2019-09-10 13:37:05', '2019-11-15 16:44:53');
INSERT INTO `system_config` VALUES (30, 'wechat_app_id', '微信公众号appId', 'wxd90x7ec99b9d4f04', 1, b'0', NULL, '2019-09-10 16:38:21', '2019-11-15 16:44:55');
INSERT INTO `system_config` VALUES (31, 'wechat_secret', '微信公众号secret', 'cea4bca954e37bb1648b10b01ade7c14', 1, b'0', NULL, '2019-09-10 16:38:40', '2019-11-15 16:44:56');
INSERT INTO `system_config` VALUES (32, 'single_max_file_size', '单文件最大上传限制', '5120', 1, b'0', '单位 byte 默认5M', '2019-11-15 16:44:28', '2019-11-15 16:46:24');
INSERT INTO `system_config` VALUES (33, 'batch_max_file_size', '批量文件最大上传限制', '20480', 1, b'0', '单位 byte 默认20M', '2019-11-15 16:45:48', '2019-11-15 16:46:29');
INSERT INTO `system_config` VALUES (34, 'default_upload_folder', '默认文件上传的文件夹名称', 'image', 1, b'0', NULL, '2019-11-15 16:51:43', '2019-11-15 16:56:59');
...
CREATE TABLE `system_department`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部门名称',
  `code` char(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部门编号',
  `parent_code` char(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '父级编号',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:未删除 1:已删除',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `operator_name` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作人姓名',
  `operator_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '操作人id',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `code_index`(`code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '部门信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `system_dict`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字典中文名称',
  `nid` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据字典nid(英文名称)',
  `hidden_value` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '数据字典隐藏值 1~∞',
  `show_value` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '显示值',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:正常,1:已删除',
  `locked` bit(1) NULL DEFAULT b'0' COMMENT '锁定状态(禁止编辑):0:未锁定 1:锁定',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统数据字典表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of system_dict
-- ----------------------------
INSERT INTO `system_dict` VALUES (1, '图片分类', 'image_classify', 1, 'pc首页', b'0', b'1', '2018-11-27 17:14:49', NULL, NULL);
INSERT INTO `system_dict` VALUES (2, '图片分类', 'image_classify', 2, 'app首页', b'0', b'1', '2018-11-27 17:15:33', NULL, NULL);
INSERT INTO `system_dict` VALUES (3, '图片分类', 'image_classify', 3, 'h5首页', b'0', b'1', '2018-11-27 17:15:55', NULL, NULL);
INSERT INTO `system_dict` VALUES (4, '系统参数分类', 'config_classify', 1, '业务参数', b'0', b'1', '2019-01-11 11:02:39', '2019-01-15 10:11:36', '');
INSERT INTO `system_dict` VALUES (5, '系统参数分类', 'config_classify', 2, '系统参数', b'0', b'1', '2019-01-11 11:03:00', '2019-01-15 10:11:57', '是东方闪电2131');
INSERT INTO `system_dict` VALUES (6, '轮播图类型', 'banner_classify', 1, '首页轮播', b'0', b'0', '2019-08-23 16:09:53', '2019-08-30 11:46:03', NULL);
...
CREATE TABLE `system_menu`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '菜单名称',
  `nid` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '菜单标示符 唯一',
  `pid` int(10) UNSIGNED NOT NULL COMMENT '父节点ID,一级菜单默认为0',
  `url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '菜单地址',
  `sub_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '权限拦截路径',
  `grade` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '菜单级别 1:一级菜单(导航) 2:二级菜单(导航) 3:三级菜单(按钮)',
  `sort` int(3) NULL DEFAULT 0 COMMENT '排序规则 小的排在前面',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '状态:0:正常,1:已删除',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `nid_unique_index`(`nid`, `deleted`) USING BTREE,
  INDEX `pid_index`(`pid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1067 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统菜单表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of system_menu
-- ----------------------------
INSERT INTO `system_menu` VALUES (1001, '系统管理', 'systemManage', 0, '', '', 1, 1, b'0', '', '2018-01-25 16:13:54', '2019-09-15 12:21:19');
INSERT INTO `system_menu` VALUES (1004, '菜单管理', 'menuManage', 1001, '/system/menu/manage_page', '', 2, 1, b'0', '', '2018-01-25 16:14:01', '2019-09-15 12:21:26');
INSERT INTO `system_menu` VALUES (1007, '系统参数', 'systemParamter', 1001, '/system/config/manage_page', NULL, 2, 2, b'0', NULL, '2018-01-25 16:14:31', '2019-09-15 12:21:26');
INSERT INTO `system_menu` VALUES (1008, '用户管理', 'systemUser', 1001, '/system/operator/manage_page', NULL, 2, 3, b'0', NULL, '2018-01-25 16:14:40', '2019-09-15 12:21:27');
INSERT INTO `system_menu` VALUES (1009, '角色管理', 'roleManage', 1001, '/system/role/manage_page', NULL, 2, 4, b'0', NULL, '2018-01-25 16:14:56', '2019-09-15 12:21:27');
INSERT INTO `system_menu` VALUES (1010, '图片管理', 'imageManage', 1001, '/system/image/manage_page', NULL, 2, 5, b'0', NULL, '2018-11-28 17:02:36', '2019-09-15 12:21:28');
INSERT INTO `system_menu` VALUES (1011, '数据字典', 'dictManage', 1001, '/system/dict/manage_page', NULL, 2, 6, b'0', NULL, '2019-01-11 17:51:31', '2019-09-15 12:21:30');
INSERT INTO `system_menu` VALUES (1012, '缓存管理', 'cacheManage', 1001, '/system/cache/manage_page', '', 2, 7, b'0', NULL, '2019-01-14 15:27:58', '2019-09-15 12:21:31');
INSERT INTO `system_menu` VALUES (1013, '操作日志', 'operationManage', 1001, '/system/operation/manage_page', NULL, 2, 8, b'0', NULL, '2019-01-16 14:31:01', '2019-09-15 12:21:31');
INSERT INTO `system_menu` VALUES (1014, '部门管理', 'departmentManage', 1001, '/system/department/manage_page', NULL, 2, 9, b'0', NULL, '2019-01-17 18:03:54', '2019-09-15 12:21:39');
INSERT INTO `system_menu` VALUES (1015, '新增', 'menuManageAdd', 1004, '/system/menu/add', '/system/menu/add_page', 3, 2, b'0', '按钮权限', '2019-01-22 14:16:11', '2019-09-15 12:21:52');
INSERT INTO `system_menu` VALUES (1016, '基础', 'menuManageBase', 1004, '/system/menu/list_page', '', 3, 1, b'0', '基础必选(相当于查询)', '2019-01-22 14:19:01', '2019-09-15 12:21:53');
INSERT INTO `system_menu` VALUES (1017, '运营管理', 'businessManage', 0, '', '', 1, 2, b'0', '', '2019-08-23 11:54:33', '2019-09-15 12:21:23');
INSERT INTO `system_menu` VALUES (1018, '轮播管理', 'bannerManage', 1017, '/business/banner/manage_page', '', 2, 1, b'0', '', '2019-08-23 11:55:35', '2019-09-15 12:21:55');
INSERT INTO `system_menu` VALUES (1019, '公告管理', 'noticeManage', 1017, '/business/notice/manage_page', '/business/notice/list_page', 2, 2, b'0', '', '2019-08-23 15:09:57', '2019-09-15 12:22:01');
INSERT INTO `system_menu` VALUES (1020, '短信日志', 'smsLogManage', 1017, '/business/sms_log/manage_page', '/business/sms_log/list_page', 2, 3, b'0', '', '2019-08-23 15:12:01', '2019-09-15 12:22:02');
INSERT INTO `system_menu` VALUES (1021, '短信模板', 'smsTemplate', 1017, '/business/sms_template/manage_page', '/business/sms_template/list_page', 2, 4, b'0', '', '2019-08-23 15:13:56', '2019-09-15 13:03:47');
INSERT INTO `system_menu` VALUES (1022, '版本管理', 'versionManage', 1017, '/business/version/manage_page', '/business/version/list_page', 2, 5, b'0', '', '2019-08-23 15:16:59', '2019-09-15 12:22:05');
INSERT INTO `system_menu` VALUES (1025, '任务配置', 'taskConfig', 1017, '/business/task/manage_page', '', 2, 10, b'0', '', '2019-09-09 15:36:39', '2019-09-15 12:39:49');
INSERT INTO `system_menu` VALUES (1026, '编辑', 'menuManageEdit', 1004, '/system/menu/edit', '/system/menu/edit_page', 3, 3, b'0', '', '2019-09-09 15:59:57', '2019-09-15 12:22:49');
INSERT INTO `system_menu` VALUES (1027, '删除', 'menuManageDelete', 1004, '/system/menu/delete', '', 3, 4, b'0', '', '2019-09-09 16:01:28', '2019-09-15 12:22:49');
INSERT INTO `system_menu` VALUES (1028, '基础', 'systemParamterBase', 1007, '/system/config/list_page', '', 3, 1, b'0', '基础必选(相当于查询)', '2019-09-12 16:13:51', '2019-09-15 13:02:00');
INSERT INTO `system_menu` VALUES (1029, '编辑', 'systemParamterQuery', 1007, '/system/config/edit_page', '/system/config/edit', 3, 2, b'0', '', '2019-09-12 16:15:48', '2019-09-15 12:22:51');
INSERT INTO `system_menu` VALUES (1030, '基础', 'systemUserBase', 1008, '/system/operator/list_page', '', 3, 1, b'0', '基础必选(相当于查询)', '2019-09-12 16:21:44', '2019-09-15 12:22:52');
INSERT INTO `system_menu` VALUES (1031, '编辑', 'systemUserEdit', 1008, '/system/operator/edit_page', '/system/operator/edit', 3, 2, b'0', '', '2019-09-12 16:22:32', '2019-09-15 12:22:43');
INSERT INTO `system_menu` VALUES (1032, '锁定', 'systemUserLock', 1008, '/system/operator/lock_operator', '', 3, 3, b'0', '', '2019-09-12 16:24:02', '2019-09-15 12:22:42');
INSERT INTO `system_menu` VALUES (1033, '解锁', 'systemUserUnlock', 1008, '/system/operator/unlock_operator', '', 3, 4, b'0', '', '2019-09-12 16:24:26', '2019-09-15 12:22:41');
INSERT INTO `system_menu` VALUES (1034, '重置', 'systemUserReset', 1008, '/system/operator/reset_password', '', 3, 5, b'0', '', '2019-09-12 16:25:03', '2019-09-15 12:22:40');
INSERT INTO `system_menu` VALUES (1035, '添加', 'systemUserAdd', 1008, '/system/operator/add_page', '/system/operator/add', 3, 6, b'0', '', '2019-09-12 16:26:12', '2019-09-15 12:22:38');
INSERT INTO `system_menu` VALUES (1036, '删除', 'systemUserDelete', 1008, '/system/operator/delete', '', 3, 7, b'0', '', '2019-09-12 16:34:32', '2019-09-15 12:22:37');
INSERT INTO `system_menu` VALUES (1037, '基础', 'roleManageBase', 1009, '/system/role/list_page', '', 3, 1, b'0', '', '2019-09-12 16:35:33', '2019-09-15 12:22:36');
INSERT INTO `system_menu` VALUES (1038, '添加', 'roleManageAdd', 1009, '/system/role/add_page', '/system/role/add', 3, 2, b'0', '', '2019-09-12 16:36:26', '2019-09-15 12:22:35');
INSERT INTO `system_menu` VALUES (1039, '编辑', 'roleManageEdit', 1009, '/system/role/edit_page', '/system/role/edit', 3, 3, b'0', '', '2019-09-12 16:36:47', '2019-09-15 12:22:33');
INSERT INTO `system_menu` VALUES (1040, '授权', 'roleManageAuth', 1009, '/system/role/auth_page', '/system/role/auth;/system/menu/list_page', 3, 4, b'0', '', '2019-09-12 16:37:20', '2019-09-15 12:22:32');
INSERT INTO `system_menu` VALUES (1041, '删除', 'roleManageDelete', 1009, '/system/role/delete', '', 3, 5, b'0', '', '2019-09-12 16:37:47', '2019-09-15 12:22:31');
INSERT INTO `system_menu` VALUES (1042, '基础', 'imageManageBase', 1010, '/system/image/list_page', '', 3, 1, b'0', '', '2019-09-12 16:49:04', '2019-09-15 12:22:30');
INSERT INTO `system_menu` VALUES (1043, '添加', 'imageManageAdd', 1010, '/system/image/add_page', '/system/image/add', 3, 2, b'0', '', '2019-09-12 16:50:00', '2019-09-15 12:22:29');
INSERT INTO `system_menu` VALUES (1044, '编辑', 'imageManageEdit', 1010, '/system/image/edit_page', '/system/image/edit', 3, 3, b'0', '', '2019-09-12 16:51:26', '2019-09-15 12:22:28');
INSERT INTO `system_menu` VALUES (1045, '删除', 'imageManageDelete', 1010, '/system/image/delete', '', 3, 4, b'0', '', '2019-09-12 16:51:45', '2019-09-15 12:22:27');
INSERT INTO `system_menu` VALUES (1046, '基础', 'dictManageBase', 1011, '/system/dict/list_page', '', 3, 1, b'0', '', '2019-09-12 16:54:05', '2019-09-15 12:22:27');
INSERT INTO `system_menu` VALUES (1047, '添加', 'dictManageAdd', 1011, '/system/dict/add_page', '/system/dict/add', 3, 2, b'0', '', '2019-09-12 16:55:21', '2019-09-15 12:22:24');
INSERT INTO `system_menu` VALUES (1048, '编辑', 'dictManageEdit', 1011, '/system/dict/edit_page', '/system/dict/edit', 3, 3, b'0', '', '2019-09-12 16:55:43', '2019-09-15 12:22:25');
INSERT INTO `system_menu` VALUES (1049, '删除', 'dictManageDelete', 1011, '/system/dict/delete', '', 3, 4, b'0', '', '2019-09-12 16:56:13', '2019-09-15 12:22:24');
INSERT INTO `system_menu` VALUES (1050, '基础', 'cacheManageBase', 1012, '/system/cache/list', '', 3, 1, b'0', '', '2019-09-12 16:58:30', '2019-09-15 12:22:21');
INSERT INTO `system_menu` VALUES (1051, '清除', 'cacheManageClear', 1012, '/system/cache/clear', '', 3, 2, b'0', '', '2019-09-12 16:59:33', '2019-09-15 12:22:22');
INSERT INTO `system_menu` VALUES (1052, '基础', 'bannerManageBase', 1018, '/business/banner/list_page', '', 3, 1, b'0', '', '2019-09-12 17:03:26', '2019-09-15 12:22:19');
INSERT INTO `system_menu` VALUES (1053, '添加', 'bannerManageAdd', 1018, '/business/banner/add_page', '/business/banner/add', 3, 2, b'0', '', '2019-09-12 17:03:49', '2019-09-15 12:22:19');
INSERT INTO `system_menu` VALUES (1054, '编辑', 'bannerManageEdit', 1018, '/business/banner/edit_page', '/business/banner/edit', 3, 3, b'0', '', '2019-09-12 17:04:18', '2019-09-15 12:22:17');
INSERT INTO `system_menu` VALUES (1055, '删除', 'bannerManageDelete', 1018, '/business/banner/delete', '', 3, 4, b'0', '', '2019-09-12 17:04:45', '2019-09-15 12:22:18');
INSERT INTO `system_menu` VALUES (1056, '任务日志', 'taskLog', 1017, '/business/task_log/manage_page', '', 2, 20, b'0', '', '2019-09-12 17:38:17', '2019-09-15 12:22:16');
INSERT INTO `system_menu` VALUES (1057, '基础', 'taskConfigBase', 1025, '/business/task/list_page', '', 3, 1, b'0', '', '2019-09-15 12:41:57', '2019-09-15 12:41:57');
INSERT INTO `system_menu` VALUES (1058, '编辑', 'taskConfigEdit', 1025, '/business/task/edit_page', '/business/task/edit', 3, 2, b'0', '', '2019-09-15 12:57:40', '2019-09-15 13:01:50');
INSERT INTO `system_menu` VALUES (1059, '基础', 'smsTemplateBase', 1021, '/business/sms_template/list_page', '', 3, 1, b'0', '', '2019-09-15 13:04:45', '2019-09-15 13:04:45');
INSERT INTO `system_menu` VALUES (1060, '编辑', 'smsTemplateEdit', 1021, '/business/sms_template/edit_page', '/business/sms_template/edit', 3, 2, b'0', '', '2019-09-15 13:05:38', '2019-09-15 13:05:38');
INSERT INTO `system_menu` VALUES (1061, '基础', 'versionManageBase', 1022, '/business/version/list_page', '', 3, 1, b'0', '', '2019-09-15 13:06:36', '2019-09-15 13:06:36');
INSERT INTO `system_menu` VALUES (1062, '添加', 'versionManageAdd', 1022, '/business/version/add_page', '/business/version/add', 3, 2, b'0', '', '2019-09-15 13:07:18', '2019-09-15 13:07:18');
INSERT INTO `system_menu` VALUES (1063, '编辑', 'versionManageEdit', 1022, '/business/version/edit_page', '/business/version/edit', 3, 3, b'0', '', '2019-09-15 13:07:51', '2019-09-15 13:07:51');
INSERT INTO `system_menu` VALUES (1064, '上架', 'versionManagePut', 1022, '/business/version/put_away', '', 3, 4, b'0', '', '2019-09-15 13:08:32', '2019-09-15 13:08:32');
INSERT INTO `system_menu` VALUES (1065, '下架', 'versionManageDown', 1022, '/business/version/sold_out', '', 3, 5, b'0', '', '2019-09-15 13:09:11', '2019-09-15 13:09:11');
INSERT INTO `system_menu` VALUES (1066, '删除', 'versionManageDelete', 1022, '/business/version/delete', '', 3, 6, b'0', '', '2019-09-15 13:09:34', '2019-09-15 13:09:34');
...
CREATE TABLE `system_notice`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '公告标题',
  `classify` tinyint(2) UNSIGNED NULL DEFAULT NULL COMMENT '公告类型(数据字典表notice_classify)',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '公告内容(富文本)',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:正常 1:删除',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统公告信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `system_operation_log`  (
  ...
  `operator_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '操作人',
  `operator_name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作人姓名',
  `request` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '请求参数',
  `response` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '响应参数',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `ip` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '访问ip',
  `business_time` bigint(12) UNSIGNED NULL DEFAULT NULL COMMENT '业务耗时',
  `classify` tinyint(1) UNSIGNED NULL DEFAULT NULL COMMENT '操作日志分类,参考:MethodType',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台操作记录' ROW_FORMAT = Compact;
...
CREATE TABLE `system_operator`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `operator_name` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户名称',
  `mobile` char(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '手机号码(登陆账户)',
  `state` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '用户状态:0:锁定,1:正常',
  `pwd` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登陆密码MD5',
  `init_pwd` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '初始密码',
  `department` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属部门',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:正常,1:已删除',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `name_index`(`operator_name`) USING BTREE,
  INDEX `mobile_index`(`mobile`) USING BTREE,
  INDEX `status_index`(`state`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '管理后台用户表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of system_operator
-- ----------------------------
INSERT INTO `system_operator` VALUES (1, '超管', '13000000000', 1, '$2a$10$ztSM0sQT.mqMOZBXxjYCK.IOHiKtCvUdKei/drs0qmm081omlcvC6', '$2a$10$5r2rvlqCSSwOHRvoBxQNkecRVKOqcIFF3NY3.FHnrTdtTp7Fmh2omy', '0', b'0', '2018-01-26 10:38:20', '2019-07-19 15:41:56', '');
...
CREATE TABLE `system_operator_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id_index`(`operator_id`) USING BTREE,
  INDEX `role_id_index`(`role_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色与用户关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `system_role`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `role_name` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '角色名称',
  `role_type` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '角色类型',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态:0:正常,1:已删除',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
...
-- ----------------------------
INSERT INTO `system_role` VALUES (1, '超级管理员', 'administrator', '2018-01-29 13:45:49', '2019-01-15 15:30:07', b'0', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 507 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色与菜单关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `task_config`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '定时任务名称',
  `nid` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '定时任务nid',
  `bean_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'bean名称 必须实现Task接口',
  `cron_expression` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'cron表达式',
  `state` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '状态 0:关闭 1:开启',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `nid_unique_index`(`nid`) USING BTREE COMMENT 'nid必须唯一'
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时任务配置表' ROW_FORMAT = Compact;
...
CREATE TABLE `task_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `nid` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务nid',
  `bean_name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '定时任务bean名称',
  `state` bit(1) NULL DEFAULT b'1' COMMENT '执行结果 0:失败 1:成功',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始执行时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '执行结束时间',
  `error_msg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '执行错误时的信息',
  `ip` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '执行任务的机器ip',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `nid_index`(`nid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时任务执行日志' ROW_FORMAT = Compact;
...
CREATE TABLE `user`  (
  ...
  `open_id` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '微信小程序openId',
  `nick_name` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '昵称',
  `email` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电子邮箱',
  `pwd` char(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登陆密码',
  `state` bit(1) NULL DEFAULT b'1' COMMENT '状态 0:注销  1正常 ',
  `channel` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '注册渠道',
  `register_ip` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '注册地址',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '前台用户基本信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '13136113636', NULL, '二哥真的很猛', '664956140@qq.com', NULL, b'1', 0, '127.0.0.1', '2019-10-25 15:59:22', '2019-10-25 16:01:16');
...
CREATE TABLE `user_ext`  (
  ...
  `real_name` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `id_card` char(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '身份证号码(前10位加密[18位身份证],前8位加密[15位身份证])',
  `birthday` char(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '生日yyyyMMdd',
  `sex` tinyint(1) UNSIGNED NULL DEFAULT NULL COMMENT '性别 0:未知 1:男 2:女',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `user_id_index`(`user_id`) USING BTREE COMMENT '唯一索引'
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '普通用户扩展信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `version`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `classify` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '版本类型 ANDROID IOS',
  `version` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '版本号:1.2.8',
  `force_update` bit(1) NULL DEFAULT b'0' COMMENT '是否强制更新 0:否 1:是',
  `url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '下载地址,android为实际下载地址,ios是跳转到app_store',
  `add_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '上传时间',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注信息:版本更新的东西或解决的问题',
  `deleted` bit(1) NULL DEFAULT b'0' COMMENT '删除状态 0:未删除 1:已删除',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `state` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '上架状态 0:未上架 1:上架',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'APP版本管理表' ROW_FORMAT = Compact;
