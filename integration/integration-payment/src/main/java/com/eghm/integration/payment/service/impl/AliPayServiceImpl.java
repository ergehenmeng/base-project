...
import com.eghm.integration.payment.enums.RefundChannel;
import com.eghm.integration.payment.enums.RefundStatus;
...
public class AliPayServiceImpl implements PayService {
    ...
    public RefundVO queryRefund(String tradeNo, String refundNo) {
        ...
        model.setOutTradeNo(tradeNo);
        model.setQueryOptions(List.of("gmt_refund_pay", "refund_detail_item_list"));
        request.setBizModel(model);
