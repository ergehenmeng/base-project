...
public class LineRefundAuditPassHandler extends AbstractRefundAuditPassHandler {

    public LineRefundAuditPassHandler(OrderService orderService, OrderRefundLogService orderRefundLogService, OrderVisitorService orderVisitorService) {
