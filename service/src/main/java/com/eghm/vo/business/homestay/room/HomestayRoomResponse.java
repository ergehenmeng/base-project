...
public class HomestayRoomResponse extends ExcelStyle {
    ...
    @ExcelProperty(value = "几室", index = 3)
    private Integer room;

    @ApiModelProperty(value = "几厅")
    @ExcelProperty(value = "几厅", index = 4)
    private Integer hall;

    @ApiModelProperty(value = "几厨")
    @ExcelProperty(value = "几厨", index = 5)
    private Integer kitchen;

    @ApiModelProperty(value = "卫生间数")
    @ExcelProperty(value = "卫生间数", index = 6)
    private Integer washroom;

    @ApiModelProperty(value = "面积")
    @ExcelProperty(value = "面积", index = 7)
    private Integer dimension;

    @ApiModelProperty(value = "居住人数")
    @ExcelProperty(value = "居住人数", index = 8)
    private Integer resident;

    @ApiModelProperty(value = "床数")
    @ExcelProperty(value = "床数", index = 9)
    private Integer bed;

    @ApiModelProperty(value = "房型类型 1:整租 2:单间 3:合租")
    @ExcelProperty(value = "房型类型(1:整租 2:单间 3:合租)", index = 10)
    private Integer roomType;

    @ApiModelProperty(value = "退款方式 0:不支持 1:直接退款 2:审核后退款")
    @ExcelProperty(value = "退款方式", index = 11, converter = EnumExcelConverter.class)
