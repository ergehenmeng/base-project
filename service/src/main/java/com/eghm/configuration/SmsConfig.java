...
public class SmsConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "system.sms", name = "sms-channel", havingValue = "ali", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "system.sms", name = "sms-channel", havingValue = "tencent")
