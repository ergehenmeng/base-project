...
public enum ExchangeQueue {
     ...
     * 订单支付完成
     */
    ORDER_PAY_SUCCESS("order_pay_success_exchange", ExchangeType.FANOUT, new String[]{ QueueConstant.ORDER_PAY_RANKING_QUEUE}, "", false),

    /**
     * 订单支付完成
     */
    ITEM_ORDER_NOTIFY("item_order_notify_exchange", ExchangeType.FANOUT, new String[]{QueueConstant.ITEM_ORDER_NOTIFY_QUEUE}, "", false),
