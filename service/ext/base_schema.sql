...
(
    `id`          bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `nid`         varchar(50)  DEFAULT NULL COMMENT '参数标示符',
    `title`       varchar(50)  DEFAULT NULL COMMENT '参数名称',
    `content`     varchar(500) DEFAULT NULL COMMENT '参数值',
...
(
    ...
    `code`          varchar(50)  DEFAULT NULL COMMENT '菜单标示符(自动生成)',
    `icon`          varchar(30)  DEFAULT NULL COMMENT '图标地址(菜单才有icon)',
    `pid`           varchar(20)  DEFAULT NULL COMMENT '父节点ID,一级菜单默认为0',
