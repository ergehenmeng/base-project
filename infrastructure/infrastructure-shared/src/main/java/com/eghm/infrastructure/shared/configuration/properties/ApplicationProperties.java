package com.eghm.infrastructure.shared.configuration.properties;
...
public class ApplicationProperties {
    ...
    public static class ManageProperties {
         ...
         * 验证码类型
         */
        private String captchaType = "com.eghm.interfaces.core.configuration.captcha.MathCaptchaProducer";
