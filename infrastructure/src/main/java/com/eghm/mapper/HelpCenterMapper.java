...
import com.eghm.po.HelpCenterPO;
 ...
 * @author 二哥很猛
 */
public interface HelpCenterMapper extends BaseMapper<HelpCenterPO> {
     ...
     */
    List<HelpCenterPO> getList(@Param("helpType") Integer helpType, @Param("queryName") String queryName);
}
