...
<head>
    ...
    <script type="text/javascript">
        ...
        var addTitle = "添加版本信息";
        var addUrl = "/version/add_page";

        var editTitle = "编辑版本信息";
        var editUrl = "/version/edit_page";

        var  delMsg = "确定要执行该操作吗";
        var delUrl = "/version/delete";

        var putAwayMsg = "确定要上架该版本吗";
        var putAwayUrl = "/version/put_away";

        var soldOutMsg = "确定要下架该版本吗";
        var soldOutUrl = "/version/sold_out";

        var address = "${address!}";
        $(function() {
            dataGrid = $.fn.dataGridOptions.dataGrid("#dataGrid",{
                url : "/version/list_page",
                columns : [ [
                    {
                        field : "icon-action",
                        title : "操作",
