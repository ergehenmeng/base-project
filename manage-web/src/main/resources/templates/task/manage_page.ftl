                ...
                columns : [ [
                    {
                        ...
                        formatter : function(value, row) {
                            ...
                            <@auth nid = "taskConfigEdit">
                                str += '<a href="javascript:void(0);" class="edit" onclick="$.fn.dataGridOptions.editFun('+row.id+',editTitle,winWidth,winHeight,editUrl);" title="编辑定时任务"></a>';
                            </@auth>
                            return str;
                        }
                    },
