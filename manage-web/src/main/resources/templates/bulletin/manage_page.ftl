...
<head>
    ...
    <script type="text/javascript">
        ...
        var addTitle = "添加公告";
        var addUrl = "/bulletin/add_page";

        var editTitle = "编辑公告";
        var editUrl = "/bulletin/edit_page";

        var  delMsg = "确定要执行该操作吗";
        var delUrl = "/bulletin/delete";

        var publishMsg = "确定要发布该公告吗";
        var publishUrl = "/bulletin/publish";

        var cancelPublishMsg = "确定要取消该公告吗";
        var cancelPublishUrl = "/bulletin/cancel_publish";

        $(function() {
            dataGrid = $.fn.dataGridOptions.dataGrid("#dataGrid",{
                url : "/bulletin/list_page",
                columns : [ [
                    {
                        field : "icon-action",
                        title : "操作",
                    ...
                    {field : "title",title : "标题",width : 150,align : "center",
                        formatter :function (value,row) {
                            return "<a href='/bulletin/preview?id=" + row.id + "' target='_blank'>" + value + "</a>";
                        }
                    },
