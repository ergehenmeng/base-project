...
import com.eghm.platform.config.service.ClearCacheService;
...
public class ClearCacheServiceImpl implements ClearCacheService {
    ...
    public void clearSensitiveWord() {
        sensitiveWordReloader.reloadLexicon(true);
        log.info("敏感词缓存清除成功");
    }
    ...
    @Override
    @CacheEvict(cacheNames = {CacheConstant.SYS_AREA_ID, CacheConstant.SYS_AREA}, allEntries = true)
